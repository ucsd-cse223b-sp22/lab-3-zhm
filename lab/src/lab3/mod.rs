...
//! GitHub classroom link available through the Lab 3 class announcement. Once
...
//!
//! - No network errors; when a TCP connection is lost you can assume that the
//!   RPC server crashed.
...
//!
//! While not necessary to complete the lab, you may wish to implement an RPC
//! service so that keepers can communicate with one another.
//!
//! You are allowed to define an RPC interface that is used between the keepers.
//! Use protobuf syntax to define the messages and RPC calls that your keepers
//! will use. Refer to the [protobuf language
